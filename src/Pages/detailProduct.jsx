    ...
    return (
        <div className="flex justify-center w-100 min-h-screen items-center">
            {Object.keys(product).length > 0 && (
                <div className="flex font-sans bg-slate-800 max-w-3xl rounded-lg  shadow-2xl group">
                    <div className="flex-none w-56 relative">
                        <img
                            src={product.image}
                            alt={product.title}
                            className="absolute inset-0  w-full h-full object-cover rounded-lg group-hover:scale-105 transition duration-500 ease-in-out"
                            loading="lazy"
                        />
                    </div>
                    <form className="flex-auto p-6">
                        <div className="flex flex-wrap">
                            <h1 className="flex-auto font-medium text-white text-xl">
                                {product.title}
                            </h1>
                        ...
                        <div className="flex space-x-4 mb-5 text-sm font-medium">
                            <div className="flex-auto flex space-x-4">
                                ...
                                <button
                                    className="h-10 px-6 font-semibold rounded-full border border-slate-200 text-slate-500"
                                    type="button"
                                >
                                    Add to bag
                                </button>
